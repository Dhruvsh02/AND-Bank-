...
SECRET_KEY = config('DJANGO_SECRET_KEY', default='transaction_service-dev-secret')
...
DATABASES = {'default': {'ENGINE': 'django.db.backends.mysql','NAME': config('DB_NAME', default='andbank_transaction_service'),'USER': config('DB_USER', default='root'),'PASSWORD': config('DB_PASSWORD', default=''),'HOST': config('DB_HOST', default='mysql'),'PORT': config('DB_PORT', default='3306'),'OPTIONS': {'charset': 'utf8mb4'}}}
...
# JWT middleware
MIDDLEWARE += ['transaction_service.middleware.JWTUserMiddleware']

# Override DRF permissions
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': ['transaction_service.permissions.IsAuthenticated'],
