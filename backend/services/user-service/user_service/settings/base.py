...
SECRET_KEY = config('DJANGO_SECRET_KEY', default='user_service-dev-secret')
...
DATABASES = {'default': {'ENGINE': 'django.db.backends.mysql','NAME': config('DB_NAME', default='andbank_user_service'),'USER': config('DB_USER', default='root'),'PASSWORD': config('DB_PASSWORD', default=''),'HOST': config('DB_HOST', default='mysql'),'PORT': config('DB_PORT', default='3306'),'OPTIONS': {'charset': 'utf8mb4'}}}
